 ...
 */
public class PaymentTypeReportFragment extends Fragment {

    protected static final String ARG_SECTION_NUMBER = "section_number";

    public static PaymentTypeReportFragment newInstance(int sectionNumber) {
        PaymentTypeReportFragment fragment = new PaymentTypeReportFragment();
    ...
    public PaymentTypeReportFragment() {
    }
